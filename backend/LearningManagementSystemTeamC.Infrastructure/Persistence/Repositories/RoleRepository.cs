...
public class RoleRepository : IRoleRepository
{
    ...
    public async Task<IEnumerable<Role>> GetAllActiveAsync(CancellationToken cancellationToken)
    {
        return await _context.Roles.Where(x => x.IsActive).ToListAsync(cancellationToken);
    }
